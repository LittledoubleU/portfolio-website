const projects = [
    {
        ...
        content: {
            header: "Puppy Cat E-commerce Website",
            img: ["", "", ""], // for slider
            link: "https://yourlink.com",
            tools: ["HTML", "CSS", "JavaScript"],
            detail: "This is an e-commerce website focused on selling puppy and cat-related products."
        }
    },
    {
        thumbnail: {
        ...
        content: {
            header: "To do List Project Website",
            img: ["", "", ""], // for slider
            link: "https://yourlink.com",
    ...
    },
    {
        ...
        content: {
            header: "Squeeze-That-Circle Game Website",
            img: ["", "", ""], // for slider
            link: "https://yourlink.com",
            tools: ["HTML", "CSS", "JavaScript"],
    ...
    },
    {
        ...
        content: {
            header: "Frontend Project (Genshin Icon Animated)",
            img: ["", "", ""], // for slider
            link: "https://yourlink.com",
            tools: ["HTML", "CSS", "JavaScript"],
    ...
    },
    {
        ...
        content: {
            header: "Plastic Pollution Data Visualization Project Competition",
            img: ["", "", ""], // for slider
            link: "https://yourlink.com",
    ...
    {
        thumbnail: {
            name: "Database Schema Design, Front-end (Bootstrap5), Back-end (Flask), UX/UI design for University Project",
            img: "path/to/your/image.jpg",
            description: "Full-stack, Database, UX/UI, Flask"
        },
        content: {
            header: "University Project (Database & Full-stack)",
            img: ["", "", ""], // for slider
            link: "https://yourlink.com",
    ...
    },
    {
        ...
        content: {
            header: "Project for Learning React.js",
            img: ["", "", ""], // for slider
            link: "https://yourlink.com",
            tools: ["React.js"],
    ...
    },
    {
        ...
        content: {
            header: "Pure JavaScript Skill Challenge & Deployment",
            img: ["", "", ""], // for slider
            link: "https://yourlink.com",
    ...
    },
    {
        ...
        content: {
            header: "CSS Transition & Animation Focus Project",
            img: ["", "", ""], // for slider
            link: "https://yourlink.com",
            tools: ["CSS", "HTML"],
    ...
    },
    {
        ...
        content: {
            header: "Weather Forecasting App (React.js)",
            img: ["", "", ""], // for slider
            link: "https://yourlink.com",
    ...
    },
    {
        ...
        content: {
            header: "Web Scraping Project (Selenium & BeautifulSoup)",
            img: ["", "", ""], // for slider
            link: "https://yourlink.com",
            tools: ["Python", "Selenium", "BeautifulSoup"],
            detail: "We won first place in a competition where my role was web scraping using Selenium and BeautifulSoup."
        }
    }
]
